...
public class ExtentReportsListener implements ITestListener, ISuiteListener{
	...
	public void onStart(ISuite suite) {
		...
		report.init(propertyUtility.getPropertyData(PropertyKey.)+"ExtentReport"+randomName, propertyUtility.getPropertyData(PropertyKey.EXTENTREPORTTITLE),propertyUtility.getPropertyData(PropertyKey.EXTENTREPORTNAME), propertyUtility.getPropertyData(PropertyKey.BROWSER));
		sreport = report;
	}
